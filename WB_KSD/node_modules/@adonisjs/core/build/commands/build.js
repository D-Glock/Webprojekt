	...
	*/
	async run() {
		...
		*/
		...
		if (!await bundler.bundle(stopOnError, this.packageManager, { tsconfigPath: this.tsconfig })) this.exitCode = 1;
	}
};
...
__decorate([flags.string({ description: "Define the tsconfig path" })], Build.prototype, "tsconfig", void 0);
//#endregion
